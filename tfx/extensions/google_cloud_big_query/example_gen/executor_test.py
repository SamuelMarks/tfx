...
class ExecutorTest(tf.test.TestCase):
  ...
  @mock.patch.multiple(
      utils,
      readFromBigQueryImpl=_MockReadFromBigQuery2,  # pylint: disable=invalid-name, unused-argument
  )
  ...
  @mock.patch.multiple(
      utils,
      readFromBigQueryImpl=_MockReadFromBigQuery,  # pylint: disable=invalid-name, unused-argument
  )
  @mock.patch.object(bigquery, 'Client')
